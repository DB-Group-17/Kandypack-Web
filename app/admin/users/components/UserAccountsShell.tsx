...
/**
 * @file UserAccountsShell.tsx
 * @description Layout shell for the User Accounts management module (/admin/users).
 * Conforms to DESIGN.md and UI/user_accounts/ reference:
 * - 260px fixed deep-violet sidebar (#5A4FE0) with active link on "Users"
 * - Sticky top navigation bar with search and administrator profile badge
 * - Responsive slide-over drawer for mobile viewports
 */

import React, { useState } from 'react';
import Link from 'next/link';

interface UserAccountsShellProps {
 ...
 */
export const UserAccountsShell: React.FC<UserAccountsShellProps> = ({
  children,
  searchQuery = '',
  onSearchChange,
}) => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5FA] flex flex-col antialiased">
      {/* Fixed 260px Deep-Violet Desktop Sidebar (#5A4FE0) */}
      <aside className="hidden md:flex flex-col fixed inset-y-0 left-0 w-[260px] bg-[#5A4FE0] text-white z-30 shadow-xl">
        ...
        {/* Sidebar Footer with Status Indicator */}
      ...
      {/* Mobile Drawer Navigation (Toggled on smaller viewports) */}
      {mobileMenuOpen && (
